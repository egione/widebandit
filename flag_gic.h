...
*/
/*
Gaussian Information Criterion Version Info
*/
/*
...
*/
#define GIC_BUILD_BREAK_COUNT 0
#define GIC_BUILD_BREAK_COUNT_EXPECTED 0
#if GIC_BUILD_BREAK_COUNT!=GIC_BUILD_BREAK_COUNT_EXPECTED
  #error GIC is unaware of the latest non-backward-compatible changes to the libraries that it uses.
#endif
/*
...
*/
#define GIC_BUILD_FEATURE_COUNT 0
/*
