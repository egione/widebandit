...
*/
#define FRU64_BUILD_BREAK_COUNT 2
#define FRU64_BUILD_BREAK_COUNT_EXPECTED 2
#if FRU64_BUILD_BREAK_COUNT!=FRU64_BUILD_BREAK_COUNT_EXPECTED
  #error Fracterval U64 is unaware of the latest non-backward-compatible changes to the libraries that it uses.
#endif
/*
...
*/
#define FRU64_BUILD_FEATURE_COUNT 2
/*
