...
*/
#define FAKEFLOAT_BUILD_BREAK_COUNT 0
#define FAKEFLOAT_BUILD_BREAK_COUNT_EXPECTED 0
#if FAKEFLOAT_BUILD_BREAK_COUNT!=FAKEFLOAT_BUILD_BREAK_COUNT_EXPECTED
  #error FakeFloat is unaware of the latest non-backward-compatible changes to the libraries that it uses.
#endif
/*
...
*/
#define FAKEFLOAT_BUILD_FEATURE_COUNT 0
/*
