...
extern u8 filesys_file_mem_map(int *descriptor_base, u64 *file_size_base, char *filename_base, void **mem_map_base_base, u8 write_status);
extern u8 filesys_file_mem_unmap(int descriptor, u64 file_size, void *mem_map_base);
...
#endif
extern u8 filesys_file_write(u8 append_status, ULONG file_size, char *filename_base, void *void_list_base);
extern u8 filesys_file_write_next_obnoxious(u8 append_status, ULONG file_size, ULONG *filename_idx_base, char *filename_list_base, void *void_list_base);
extern u8 filesys_file_write_obnoxious(u8 append_status, ULONG file_size, char *filename_base, void *void_list_base);
extern ULONG filesys_filename_isolate(ULONG *filename_idx_min_base, char *filename_list_base);
extern u8 filesys_filename_list_get(u8 *fatal_status_base, ULONG *file_size_max_base, ULONG *file_size_sum_base, u8 *file_status_base, ULONG *filename_count_base, char *filename_list_base, ULONG *filename_list_size_max_base, char *target_base);
...
extern u8 filesys_subfile_read(u8 direction_status, char *filename_base, ULONG read_size, u64 read_u8_idx_min, void *void_list_base);
...
extern u8 filesys_subfile_write(u8 direction_status, char *filename_list_base, ULONG write_size, u64 write_u8_idx_min, void *void_list_base);
