...
*/
#define ARCHIVE_BUILD_BREAK_COUNT 0
#define ARCHIVE_BUILD_BREAK_COUNT_EXPECTED 0
#if ARCHIVE_BUILD_BREAK_COUNT!=ARCHIVE_BUILD_BREAK_COUNT_EXPECTED
  #error Archive is unaware of the latest non-backward-compatible changes to the libraries that it uses.
#endif
/*
...
*/
#define ARCHIVE_BUILD_FEATURE_COUNT 0
/*
