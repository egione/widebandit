...
*/
#define WHOLE_BUILD_BREAK_COUNT 0
#define WHOLE_BUILD_BREAK_COUNT_EXPECTED 0
#if WHOLE_BUILD_BREAK_COUNT!=WHOLE_BUILD_BREAK_COUNT_EXPECTED
  #error Whole is unaware of the latest non-backward-compatible changes to the libraries that it uses.
#endif
/*
...
*/
#define WHOLE_BUILD_FEATURE_COUNT 0
/*
