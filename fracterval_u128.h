...
#define FRU128_BIT_MAX 255U
#define FRU128_BITS 256U
#define FRU128_BITS_LOG2 8U
#define FRU128_BYTE_MAX 31U
#define FRU128_SIZE 32U
#define FRU128_SIZE_LOG2 5U
...
#define FTD128_LOG2_FLOOR_LO 0xC9E3B39803F2F6AFULL
  ...
  #define U128_TO_U64_MID(__t, __p) \
    __t=(u64)((__p)>>32)
...
#define FRU128_TO_FRU64_HI(_t, _p) \
  U128_TO_U64_HI(_t.a, _p.a); \
  U128_TO_U64_HI(_t.b, _p.b)

#define FRU128_TO_FRU64_LO(_t, _p) \
  U128_TO_U64_LO(_t.a, _p.a); \
  U128_TO_U64_LO(_t.b, _p.b)

#define FRU128_TO_FRU64_MID(_t, _p) \
  U128_TO_U64_MID(_t.a, _p.a); \
  U128_TO_U64_MID(_t.b, _p.b)
